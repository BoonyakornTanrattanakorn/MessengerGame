...
func perform_attack_pattern() -> void:
	...
	begin_vulnerability_window(windup + 1.1)
	...
	var dir := get_direction_to_player().rotated(randf_range(-0.1, 0.1))
	spawn_projectile(dir, 0.9, 1.9, 9.0, Color(0.62, 0.42, 0.24, 1.0))
